jei yrainstancija(t1, TypeVar): # type: ignore
    tęsti
...
jei           : keyword.control.flow.python, source.python
              : source.python
yrainstancija : meta.function-call.python, source.python, support.function.builtin.python
...
ignore        : comment.line.number-sign.python, comment.typehint.ignore.notation.python, meta.typehint.comment.python, source.python
              : source.python
tęsti         : keyword.control.flow.python, source.python
