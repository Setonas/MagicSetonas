f'insane{42 + 9000}stuff{apibrėžti aaa(): pereiti}'
# apibrėžti aaa() must not be parsed as a valid declaration
...
{             : constant.character.format.placeholder.other.python, meta.fstring.python, source.python
apibrėžti     : keyword.control.flow.python, meta.fstring.python, source.python
              : meta.fstring.python, source.python
...
:             : meta.fstring.python, punctuation.separator.colon.python, source.python
              : meta.fstring.python, source.python
pereiti       : keyword.control.flow.python, meta.fstring.python, source.python
}             : constant.character.format.placeholder.other.python, meta.fstring.python, source.python
...
#             : comment.line.number-sign.python, punctuation.definition.comment.python, source.python
 apibrėžti aaa() must not be parsed as a valid declaration : comment.line.number-sign.python, source.python
