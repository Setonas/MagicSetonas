some_number: sveik           # variable without initial value
some_list: List[sveik] = []  # variable with initial value
...
:             : punctuation.separator.colon.python, source.python
              : source.python
sveik         : source.python, support.type.python
              : source.python
...
sveik         : meta.item-access.arguments.python, meta.item-access.python, source.python, support.type.python
