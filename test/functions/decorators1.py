@some_decorator # su comment
@some.rūšis.decorator
@some_decorator(1)
@some.decorator   (1, 3)
@some_decorator(a=2, b={'q': 42}, **kwargs)
@classmethod
apibrėžti decorated(a): pereiti
...
#             : comment.line.number-sign.python, punctuation.definition.comment.python, source.python
 su comment   : comment.line.number-sign.python, source.python
@             : entity.name.function.decorator.python, meta.function.decorator.python, source.python
some          : entity.name.function.decorator.python, meta.function.decorator.python, source.python
.             : entity.name.function.decorator.python, meta.function.decorator.python, source.python
rūšis         : keyword.control.flow.python, meta.function.decorator.python, source.python
.             : entity.name.function.decorator.python, meta.function.decorator.python, source.python
