...
# format spec. Otherwise, it would be hard to spot an error iš
# the code below.
a = '12% of %s' % ('name',)
...
#             : comment.line.number-sign.python, punctuation.definition.comment.python, source.python
 format spec. Otherwise, it would be hard to spot an error iš : comment.line.number-sign.python, source.python
#             : comment.line.number-sign.python, punctuation.definition.comment.python, source.python
